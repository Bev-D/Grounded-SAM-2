...
from sam2 import sam2_image_predictor,sam2_video_predictor,build_sam
...
def load_model_hf(repo_id, filename, ckpt_config_filename, device='cpu'):
    ...
    cache_config_file = './huggingface/GroundingDINO_SwinB_cfg.py'
    ...
    cache_file = './huggingface/groundingdino_swinb_cogcoor.pth'
...
class LangSAM():
    ...
    def build_sam(self, ckpt_path):
        ...
        #     sam.to(device=self.device)
        #     self.sam = SamPredictor(sam)
        sam2 =ModelManager.get_sam2_model()
        self.sam = sam2_image_predictor.SAM2ImagePredictor(sam2)
    ...
    def build_groundingdino(self):
        ...
        self.groundingdino = ModelManager.get_grounding_model()
    ...
    def predict(self, image_pil, text_prompt, box_threshold=0.15, text_threshold=0.5):
