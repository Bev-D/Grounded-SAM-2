...
def run_image_inference(
    ...
    sam2_predictor = ModelManager.get_sam2_predictor()
...
if __name__ == "__main__":
    ...
    args = parser.parse_args([
        "--img-path", "D:\Work\AItemp\Grounded-SAM-2/results/222/2/video_frames/00094.jpg",
        "--client_id", "car",
        "--text-prompt", "car. tree. Motorcycle. Traffic light."
    ])
